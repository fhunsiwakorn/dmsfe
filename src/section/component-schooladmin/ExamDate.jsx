...
export default class ExamDate extends Component {
  ...
  render() {
    ...
    const { ed_start_time } = this.state;
    const { ed_hour } = this.state;
    const { ed_end_time } = this.state;
    const { ed_date } = this.state;
    const { ed_ready } = this.state;
    const { teacher_id } = this.state;
    const { staff_exam_type } = this.state;
